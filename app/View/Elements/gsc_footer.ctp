...
<footer>
    <div class="container-fluid">
        <p class="text-white text-right">&copy; Copyright 2019 Coca-Cola</p>
    </div>
</footer>
<!-- page footer end -->
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="min-height:350px;">
                ...
                <div class="form-group">
                    ...
                    <select class="multipleSelect" multiple name="category_list[]" id="all_list">
                ...
                echo $this->Form->create(null, array(
                'url' => array('controller' => 'Gsc', 'action' => 'extractDashboardPDF'), 'id' => 'pdfExportCenter')); 

                ?>

                <div class="form-group">
                    <label>Add one or more markets</label>
                    <select class="multipleSelect" multiple name="market_list[]" id="all_list">
                        <option value="All" id="select_all">All</option>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" onclick="return askExportConfirmation('Yes', 'pdfExportCenter', '<?php echo $this->action ?>')">Download</button>
...
<div class="modal fade" id="excelModalCenter" tabindex="-1" role="dialog" aria-labelledby="excelModalCenterTitle" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" onclick="return askExportConfirmation('Yes', 'excelExportCenter', '<?php echo $this->action ?>')">Download</button>
                <button type="button" class="btn btn-light" data-dismiss="modal" >Close</button>
            </div>
        </div>
    </div>
...
<script type='text/javascript'>
    ...
    function askExportConfirmation(choice,exportId, myaction) {
