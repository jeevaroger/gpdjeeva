...
$(function () {
    ...
    $("#pass").keyup(function () {
        ...
        if (len > 10 || len == 0) {
            ...
            blsp();
            if (len != 0) {
                $('#passal').css('color', 'rgb(255, 57, 19)').text('KO ID: Too long').fadeIn()
            } else {
                $('#passal').css('color', 'rgb(255, 57, 19)').text('KO ID: Null').fadeIn()
            }
            flg.pass = 1
        } else {
            $('#pass').css('background', 'rgb(255, 255, 255)');
            $('#passal').css('color', 'rgb(17, 170, 42)').text('KO Id: Ok').fadeIn();
            flg.pass = 0;
            tcheck()
        }
    });
